          ...
          {principles.map((p, i) => (
            ...
            >
              <div className="w-12 h-12 rounded-md bg-blue-50 flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-blue-600" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M12 8c1.657 0 3-1.567 3-3.5S13.657 1 12 1 9 2.567 9 4.5 10.343 8 12 8zM4 22v-2a4 4 0 014-4h8a4 4 0 014 4v2"/></svg>
              </div>
